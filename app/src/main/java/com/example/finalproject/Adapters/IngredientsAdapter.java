...
import com.example.finalproject.Models.ExtendedIngredient;
...
public class IngredientsAdapter extends RecyclerView.Adapter<IngredientsViewHolder> {
    ...
    public IngredientsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new IngredientsViewHolder(LayoutInflater.from(context).inflate(R.layout.list_dish_ingredients, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull IngredientsViewHolder holder, int position) {
        ...
        Picasso.get().load("https://spooncular.com/cdn/ingredients_100x100/"+list.get(position).image)
